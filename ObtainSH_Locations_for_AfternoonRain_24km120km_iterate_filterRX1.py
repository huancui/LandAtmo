...
for iyear in range(year1, year2):
    ...
    for imonth in range(5):
        ...
        for iday in range(1, days[imonth]+1):
            ...
            day_ind          = day_ind+1
            hour_start       = 21       # local time: 21-6=15
            hour_end         = 27       # local time: 27-6=21
            ...
            hour_end1        = 21      # local time: 21-6=15
            ...
            MORNINGMASK_MATRIX[day_ind,:,:] = np.where(rain_2_morning > 1.0, 2, 1)
...
#                         if (ppmcs_box > 1.0):
        ...
        outfile1 = path5 + 'Afternoon_PP_max_latind_'+ str(iyear) + months[imonth] + '_24km120km_iterate_filterRX1.txt'
        outfile2 = path5 + 'Afternoon_PP_max_lonind_'+ str(iyear) + months[imonth] + '_24km120km_iterate_filterRX1.txt'
        outfile3 = path5 + 'Afternoon_PP_min_latind_'+ str(iyear) + months[imonth] + '_24km120km_iterate_filterRX1.txt'
        outfile4 = path5 + 'Afternoon_PP_min_lonind_'+ str(iyear) + months[imonth] + '_24km120km_iterate_filterRX1.txt'
        outfile5 = path5 + 'Afternoon_PP_datetime_'  + str(iyear) + months[imonth] + '_24km120km_iterate_filterRX1.txt'
        f = open(outfile1, 'w')
    ...
    outfile0   =  path5 + 'Obtain_AfternoonPP_maxind_'+str(iyear)+'_24km120km_iterate_filterRX1.nc'
...
outfile0   =  path5 + 'Obtain_AfternoonPP_frequency_allyears_24km120km_iterate_filterRX1.nc'
rootgrp    =  Dataset(outfile0,'w',format='NETCDF4')
